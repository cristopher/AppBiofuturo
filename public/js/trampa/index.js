...
var _tabla = [{"nombre":"trampa_text", "oculto": false,"type":"text"}, {"nombre":"trampa_default", "oculto": true,"type":"bool"}];
var _filtros = [{"nombre":"trampa_text_search","type":"input"}, {"nombre":"trampa_default_search","type":"checkbox"}]
...
$(document).ready(function(){
    ...
    the("saveTrampa").onclick = function(){
        document.getElementsByTagName("form")[0].submit()
    }

    the("closeTrampa").onclick = function(){
        these("trampa_text")[0].value = ""
        these("trampa_default")[0].checked = false
        these("trampa_default")[0].onchange()
    }
...
function construirOpciones(_fila,last){
    ...
    _boton.id = "btnGroupDrop" + _fila.trampa_id
    _boton.type = "button"
    ...
    _aMod.href = "trampa/edit/"+ _fila.trampa_id
    ...
    _aElim.dataset.id = _fila.trampa_id
...
function eliminarElemento(){
    make.deleteModal("el trampa", this.dataset.id, function(){
        window.location.href = '/trampa/delete/'+this.dataset.delete;
    });
}