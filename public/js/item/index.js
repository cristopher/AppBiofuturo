...
var _tabla = [{"nombre":"item_text", "oculto": false,"type":"text"}, {"nombre":"item_default", "oculto": true,"type":"bool"}];
var _filtros = [{"nombre":"item_text_search","type":"input"}, {"nombre":"item_default_search","type":"checkbox"}]
...
$(document).ready(function(){
    ...
    the("saveItem").onclick = function(){
        document.getElementsByTagName("form")[0].submit()
    }

    the("closeItem").onclick = function(){
        these("item_text")[0].value = ""
        these("item_default")[0].checked = false
        these("item_default")[0].onchange()
    }
...
function construirOpciones(_fila,last){
    ...
    _boton.id = "btnGroupDrop" + _fila.item_id
    _boton.type = "button"
    ...
    _aMod.href = "item/edit/"+ _fila.item_id
    ...
    _aElim.dataset.id = _fila.item_id
...
function eliminarElemento(){
    make.deleteModal("el item", this.dataset.id, function(){
        window.location.href = '/item/delete/'+this.dataset.delete;
    });
}