CREATE TABLE IF NOT EXISTS `huge`.`users` (
 ...
 `user_authorization` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'user''s authorizacion google',
 `user_authorization_code` varchar(256) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'user''s email autorization code',
 `user_personalized` text DEFAULT NULL,
 PRIMARY KEY (`user_id`),
...
`user_password_reset_timestamp`, `user_provider_type`) VALUES
  (1, NULL, 'WeTrust Admin', '$2y$10$OvprunjvKOOhM1h9bzMPs.vuwGIsOqZbw88rzSyGCTJTcE61g5WXi', 'cristopher@wetrust.cl', 1, 0, 7, 0, NULL, 1422205178, NULL, 1422209189, 0, NULL, NULL, NULL, NULL, 'DEFAULT'),
