<header class="pb-4 sticky-top">
    <div class="container">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <h1 class="mb-0">Cambiar contraseña de <?= $this->user->user_name; ?></h1>
        </div>
    </div>
</header>
    ...
    <div class="container py-3">
        ...
        <div class="d-flex justify-content-center">
            <div class="card shadow">
                <div class="card-body">
                    <form method="post" action="<?= Config::get('URL'); ?>admin/changePassword_action" name="new_password_form">
                        ...
                        <button type="submit" name="submit_new_password" class="btn my-4 mx-auto d-block">Guardar</button>
                    </form>
                </div>
            </div>
        </div>
