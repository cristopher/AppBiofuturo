<header class="py-4 wetrust">
    <div class="container">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <h1 class="mb-0 d-none d-lg-block mr-auto">Trampas Admin</h1>
            <h4 class="mb-0 d-lg-none mr-auto">Trampas Admin</h4>
        </div>
    </div>
</header>
<main class="minimo">
    <div class="container py-3">
        ...
        <div class="accordion" id="accordion">
            <div class="card shadow mb-3">
                <div class="card-header wetrust" id="accordionTitle">
                    <h5 class="mb-0" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/></svg> Nueva trampa</h5>
                </div>
                <div id="collapseOne" class="collapse" aria-labelledby="accordionTitle" data-parent="#accordion">
                    <div class="card-body">
                        <form method="post" action="<?= Config::get('URL');?>trampa/createAdmin">
                            ...
                            <div class="form-group">
                                <label>Texto de nueva trampa:</label>
                                <input type="text" class="form-control" name="trampa_text" autocomplete="off">
                            </div>
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" id="default" name="trampa_default">
        ...
        <table class="table table-hover border rounded shadow">
            ...
            <tbody>
                <?php foreach($this->trampas as $key => $value) { ?>
                <tr>
                    <td><?= $value->user_name; ?></td>
                    <td><?= htmlentities($value->trampa_text); ?></td>
                    <td><?= ($value->trampa_default == "1") ? "Si": "No"; ?></td>
                    <td>
                        <div class="btn-group dropleft" role="group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="btnGroupDrop<?= $value->trampa_id; ?>">
                                <a class="dropdown-item" href="trampa/editAdmin/<?= $value->trampa_id; ?>">
                                ...
                                <a class="dropdown-item delete" data-id="<?= $value->trampa_id; ?>" data-user="<?= $value->user_id; ?>">
                                    <div class="d-flex justify-content-between align-items-center">
                                        Eliminar
        ...
        <?php } else { ?>
        <div class="alert alert-info mt-2" role="alert">No hay trampas todavía. ¡Crea una!</div>
        <?php } ?>
    </div>
</main>
<script type="module" src="js/trampa/indexAdmin.js"></script>