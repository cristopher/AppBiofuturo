<header class="py-4 wetrust">
    <div class="container">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <h1 class="mb-0 d-none d-lg-block mr-auto">Inspecciones Admin</h1>
            <h4 class="mb-0 d-lg-none mr-auto">Inspecciones Admin</h4>
        </div>
    </div>
</header>
<main class="minimo">
    <div class="container py-3">
        ...
        <div class="accordion" id="accordion">
            <div class="card shadow mb-3">
                <div class="card-header wetrust" id="accordionTitle">
                    <h5 class="mb-0" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/></svg> Nueva inspeccion</h5>
                </div>
                <div id="collapseOne" class="collapse" aria-labelledby="accordionTitle" data-parent="#accordion">
                    <div class="card-body">
                        <form method="post" action="<?= Config::get('URL');?>inspeccion/createAdmin">
                            ...
                            <div class="form-group">
                                <label>Texto de nueva inspeccion:</label>
                                <input type="text" class="form-control" name="inspeccion_text" autocomplete="off">
                            </div>
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" id="default" name="inspeccion_default">
        ...
        <table class="table table-hover border rounded shadow">
            <thead class="thead-light">
                <tr>
                    ...
                    <th class="rounded">Inspeccion</th>
                    <th class="rounded">Predeterminado</th>
                    <th class="rounded w-10">Opciones</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach($this->inspecciones as $key => $value) { ?>
                <tr>
                    <td><?= $value->user_name; ?></td>
                    <td><?= htmlentities($value->inspeccion_text); ?></td>
                    <td><?= ($value->inspeccion_default == "1") ? "Si": "No"; ?></td>
                    <td>
                        <div class="btn-group dropleft" role="group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="btnGroupDrop<?= $value->inspeccion_id; ?>">
                                <a class="dropdown-item" href="inspeccion/editAdmin/<?= $value->inspeccion_id; ?>">
                                ...
                                <a class="dropdown-item delete" data-id="<?= $value->inspeccion_id; ?>" data-user="<?= $value->user_id; ?>">
                                    <div class="d-flex justify-content-between align-items-center">
                                        Eliminar
        ...
        <?php } else { ?>
        <div class="alert alert-info mt-2" role="alert">No hay inspecciones todavía. ¡Crea una!</div>
        <?php } ?>
    </div>
</main>
<script type="module" src="js/inspeccion/indexAdmin.js"></script>