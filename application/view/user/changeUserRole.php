<section>
    ...
    <main class="multicolor minimo text-white">
        <div class="container">
            ...
            <form action="<?php echo Config::get('URL'); ?>user/changeUserRole_action" method="post">
                <?php if (Session::get('user_account_type') == 1) { ?>
                    <button type="submit" name="user_account_upgrade" value="2" class="btn btn-primary shadow-lg">Subir nivel</button>
                <?php } else if (Session::get('user_account_type') == 2) { ?>
                    <button type="submit" name="user_account_downgrade" value="1" class="btn btn-primary shadow-lg">Bajar nivel</button>
                <?php } ?>
            </form>
        </div>
    </main>
